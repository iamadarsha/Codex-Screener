...
DATABASE_URL=postgresql+asyncpg://postgres.gruaokvbcnvgvklhqimw:***REMOVED-DB-PASSWORD***@aws-0-ap-south-1.pooler.supabase.com:6543/postgres
...
# ── Indian Stock API ──
INDIAN_API_KEY=***REMOVED-INDIAN-API-KEY***
...
NEXT_PUBLIC_SUPABASE_ANON_KEY=***REMOVED-SUPABASE-ANON-KEY***
```
...
|---|---|---|
| `UPSTOX_API_KEY` | `***REMOVED-UPSTOX-KEY***` | Upstox Developer Portal |
| `UPSTOX_API_SECRET` | `***REMOVED-UPSTOX-SECRET***` | Upstox Developer Portal |
| `INDIAN_API_KEY` | `***REMOVED-INDIAN-API-KEY***` | indianapi.in |
| `GEMINI_API_KEY` | `***REMOVED-GEMINI-KEY***` | Google AI Studio |
...
| Supabase DB Password | `***REMOVED-DB-PASSWORD***` | Supabase Dashboard → Settings → Database |
