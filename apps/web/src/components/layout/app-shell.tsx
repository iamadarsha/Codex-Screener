  ...
  return (
    <div className="min-h-screen bg-page text-text-primary lg:flex">
      ...
      <div className="flex min-h-screen flex-1 flex-col overflow-x-hidden min-w-0">
        ...
        <Topbar />
        <IndexTickerBar />
        <main className="flex-1 overflow-x-hidden px-3 py-4 pb-20 sm:p-6 lg:pb-6">
          {children}
          ...
          <footer className="mt-8 border-t border-border/50 pt-4 pb-2 text-center lg:hidden">
            <p className="text-[10px] text-text-muted">Made with love by a fellow trader</p>
            <p className="text-[11px] font-medium text-text-secondary mt-0.5">Trade With Adarsha</p>
            <a
